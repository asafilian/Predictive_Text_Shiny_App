...
kable(raw_info, caption = "Raw Data - Information") %>%
        ...
        footnote(general =  c("`Words`: approximate in million", "`Range nchars`: range and avgerage number of chars in lines", "`Avg nchars`: range and avgerage number of chars in lines"))
```
...
avg_nchar_corpus_sample <- avg_nchar_news_sample + avg_nchar_twitter_sample + avg_nchar_blogs_sample
